                ...
                <tr class="presentation">
                    ...
                    <td class="bg_none one_eighth" valign="top">
                        <div class="inline bg_button" title="Выбрать доверенное лицо" style="padding: 0">
                            <a href="/proxy/person_index?track=<?= $track ?>&site_page=<?= $site_page ?>&date_create=<?= $date_create ?>&package_type=<?= $package_type ?>&office=<?= $office ?>&pid=<?= $pid ?>&rid=<?= $rid ?>&user_ref=<?= USER_REFERENCE_SEND ?>&wow=<?=$with_or_without ?>&search=<?= $proxy_person['lastname'] . ' '.$proxy_person['firstname'] . ' ' . $proxy_person['middlename'] ?>">
                ...
                <tr class="presentation">
                    ...
                    <td class="bg_none one_eighth" valign="top">
                        ...
                        <div class="inline bg_button dinamic_content" title="Выбрать доверенность" style="padding: 0">
                            <a href="/proxy/person_view?track=<?= $track ?>&site_page=<?= $site_page ?>&date_create=<?= $date_create ?>&package_type=<?= $package_type ?>&office=<?= $office ?>&pid=<?= $pid ?>&rid=<?= $rid ?>&user_ref=<?= USER_REFERENCE_SEND ?>&wow=<?= $with_or_without ?>&search=&p_pid=<?= $proxy_person_id ?>">
